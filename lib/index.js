...
var PanopticonClient = /** @class */ (function () {
     ...
     */
    PanopticonClient.prototype.suggestArticleComment = function (params) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, fetcher_1.fetcher)("/articles/".concat(Buffer.from(params.articleUrl).toString("base64"), "/generate-comment"), "POST", articles_1.parseSuggestedComment, this.apiKey, {
